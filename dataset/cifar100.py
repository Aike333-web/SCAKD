...
def get_data_folder():
    ...
    data_folder = '/data/goujp/xjh/SSKD-master/data/'
    #data_folder = '/data1/mazc/gjp/xjh/SSKD-master/data/'
...
def get_cifar100_dataloaders(batch_size=128, num_workers=8, is_instance=False):
    ...
    transform_aug = transforms.Compose([
        transforms.RandomCrop(32, padding=4),
        transforms.RandomApply([transforms.ColorJitter(0.4, 0.4, 0.4, 0.1)], p=0.8),  # 随机的颜色抖动
        transforms.RandomGrayscale(p=0.2),  # 随机的灰度
    ...
    if is_instance:
        ...
        train_set = datasets.CIFAR100(root=data_folder, download=True, train=True, transform=simsiam.loader.TwoCropsTransform(train_transform,transform_aug))
