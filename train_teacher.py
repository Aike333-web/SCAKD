...
from helper.util import (AverageMeter, accuracy, adjust_learning_rate,parser_config_save, reduce_tensor, save_dict_to_json)
...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='cifar100', choices=['cifar100', 'imagenet', 'imagenette','stl10','tinyimagenet'], help='dataset')
